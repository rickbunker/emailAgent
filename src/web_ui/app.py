...
from email_interface import (
    EmailInterfaceFactory, EmailSystemType, create_email_interface,
    get_supported_systems, BaseEmailInterface, EmailSearchCriteria
)
    ...
    for attachment in email.attachments:
        try:
            ...
            email_data = {
                ...
                'subject': email.subject,
                'date': email.received_date.isoformat() if email.received_date else datetime.now(timezone.utc).isoformat(),
            ...
            if result.matched_asset_id:
                ...
                logger.info(f"Attachment processed but no asset match found")
            ...
            if not result.matched_asset_id:
                ...
                needs_review = True
                logger.info(f"Adding to human review: no asset match found")
