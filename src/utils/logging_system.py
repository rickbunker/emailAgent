...
def get_logger(name: Optional[str] = None) -> EmailAgentLogger:
...
def log_function(
    logger: Optional[EmailAgentLogger] = None,
    level: Optional[str] = None,
    log_args: Optional[bool] = None,
    log_return: Optional[bool] = None,
    log_time: Optional[bool] = None
) -> Callable:
    """
...
def log_debug(func: Optional[Callable] = None, **kwargs) -> Union[Callable, Callable[[Callable], Callable]]:
...
def log_info(func: Optional[Callable] = None, **kwargs) -> Union[Callable, Callable[[Callable], Callable]]:
...
if __name__ == "__main__":
    ...
    print("\nCheck logs/test_logging.log for file output") 